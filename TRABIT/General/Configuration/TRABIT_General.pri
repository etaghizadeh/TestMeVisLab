isEmpty(TRABIT_General_PRI_INCLUDED) {
  message ( loading TRABIT_General.pri )
}
# **InsertLicense** code
# -----------------------------------------------------------------------------
# TRABIT_General prifile
#
# \file    TRABIT_General.pri
...
PACKAGE_ROOT    = $$(MLAB_TRABIT_General)
